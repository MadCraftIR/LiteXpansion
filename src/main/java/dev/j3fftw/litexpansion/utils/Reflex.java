...
// got this from
// https://github.com/nulli0n/nightcore-spigot/blob/master/src/main/java/su/nightexpress/nightcore/util/Reflex.java
public class Reflex {
  public static @Nullable Class<?> getClass(@NotNull String path, @NotNull String name) {
    return getClass(path + "." + name);
  }

  public static @Nullable Class<?> getInnerClass(@NotNull String path, @NotNull String name) {
    return getClass(path + "$" + name);
  }

  private static @Nullable Class<?> getClass(@NotNull String path) {
    try {
  ...
  public static @Nullable Constructor<?> getConstructor(
      @NotNull Class<?> source, Class<?>... types) {
    try {
  ...
  public static @Nullable Object invokeConstructor(
      @NotNull Constructor<?> constructor, Object... obj) {
    try {
  ...
  public static @Nullable Field getField(@NotNull Class<?> source, @NotNull String name) {
    try {
  ...
  public static @Nullable Object getFieldValue(@NotNull Object source, @NotNull String name) {
    try {
  ...
  public static boolean setFieldValue(
      @NotNull Object source, @NotNull String name, @Nullable Object value) {
    try {
  ...
  public static @Nullable Method getMethod(
      @NotNull Class<?> source, @NotNull String name, @NotNull Class<?>... params) {
    try {
  ...
  public static @Nullable Object invokeMethod(
      @NotNull Method method, @Nullable Object by, @Nullable Object... param) {
