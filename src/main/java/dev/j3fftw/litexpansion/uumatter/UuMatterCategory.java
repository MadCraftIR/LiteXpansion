...
public final class UuMatterCategory extends FlexItemGroup {
  ...
  private @NotNull ChestMenu create(@Nonnull Player p) {
    final ChestMenu playerMenu =
        new ChestMenu(Slimefun.getLocalization().getMessage(p, "guide.title.main"));
  ...
  private boolean onIngredientClick(
      @NotNull PlayerProfile profile, @Nullable ItemStack clickedItem) {
    if (clickedItem != null) {
  ...
  public void open(
      ...
      @NotNull SlimefunGuideMode slimefunGuideLayout) {
