...
public class UUCrafter extends SlimefunItem
    implements InventoryBlock, EnergyNetComponent, PoweredMachine {
  ...
  public static final CustomItemStack RUNNING =
      new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, ChatColor.GRAY + "Click to stop");

  public static final CustomItemStack NOT_RUNNING =
      new CustomItemStack(Material.RED_STAINED_GLASS_PANE, ChatColor.GRAY + "Click to start");
  ...
  private void tick(@NotNull Block block) {
  ...
  public void onNewInstance(@NotNull BlockMenu menu, @NotNull Block block) {
  ...
  public void toggleRunning(@NotNull BlockMenu blockMenu, @NotNull Block block) {
