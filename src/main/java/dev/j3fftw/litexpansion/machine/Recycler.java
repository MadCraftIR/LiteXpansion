...
public class Recycler extends SlimefunItem
  ...
  private static final CustomItemStack progressItem =
      new CustomItemStack(Material.DEAD_BUSH, "&7Progress");
  ...
  private void setupInv() {
    createPreset(
        ...
        blockMenuPreset -> {
          ...
          blockMenuPreset.addItem(
              PROGRESS_SLOT, new CustomItemStack(Material.DEAD_BUSH, "&7Progress"));
