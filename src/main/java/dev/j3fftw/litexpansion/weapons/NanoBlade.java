...
public class NanoBlade extends SimpleSlimefunItem<ItemUseHandler>
    implements Rechargeable, PassiveElectricRemoval {
  ...
  public ItemUseHandler getItemHandler() {
    return event -> {
      ...
      final Enchantment enchantment = EnchantNMS.getGlowEnchantment();
      ...
      nanoBladeMeta.addAttributeModifier(
  ...
  public boolean isEnabled(@Nonnull ItemMeta meta) {
    ...
    return (opt.isPresent() && opt.get()) || meta.hasEnchant(EnchantNMS.getGlowEnchantment());
  }
}
